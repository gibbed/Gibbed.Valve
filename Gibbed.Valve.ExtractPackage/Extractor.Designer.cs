namespace Gibbed.Valve.ExtractPackage
{
	partial class Extractor
	{
		...
		private void InitializeComponent()
		{
            ...
            // openFileDialog
            // 
            this.openFileDialog.DefaultExt = "vpk";
            this.openFileDialog.Filter = "Package Directory Files (*_dir.vpk)|*_dir.vpk|All Files (*.*)|*.*";
            // 
            // savePathDialog
            // 
            this.savePathDialog.Description = "Select a directory to extract files to.";
            // 
            // Extractor
            // 
            ...
            this.Name = "Extractor";
            this.Text = "Gibbed\'s *.vpk Extractor (1.1)";
